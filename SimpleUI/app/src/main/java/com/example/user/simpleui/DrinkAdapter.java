...
public class DrinkAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.mPiceTextView = (TextView) convertView.findViewById(R.id.mPriceTextView);
        ...
        holder.mPiceTextView.setText(String.valueOf(drink.getmPrice()));
